...
T_star = 0.7 #1.2 #0.5 #0.7
T = T_star * omega_harm * N ** (1.0 / 3.0)
beta = 1.0 / T
print 'omega: ', omega
# Initial condition
filename = 'data_boson_configuration_anisotropic_pancake_07.txt'
positions = {}
...
pylab.title(str(N) + ' (pancake) bosons at T* = ' + str(T_star))
pylab.legend()
...
pylab.savefig('plot_pancake_boson_configuration_T_star%s.png' % T_star)
pylab.show()                                     
