...
filename = 'data_boson_configuration_B1_TStar=%s.txt' % T_star
positions = {}
...
if os.path.isfile(filename):
    ...
    f.close()
    print "length(positions) read: ", len(positions), " N: ", N
    if len(positions) != N:
...
pylab.savefig('plot_boson_configuration_T_star%s.png' % T_star)
pylab.show()
