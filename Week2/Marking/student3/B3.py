...
vel = [[0.11, 0.22], [0.71, 0.18], [-0.23, -0.79], [0.78, 0.1177]]
...
pylab.title('Molecular Dynamics Algorithm: x coordinate histogram (density eta=0.18)')
pylab.grid()
pylab.savefig('molecular_dynamics_histo.png')
pylab.show()
