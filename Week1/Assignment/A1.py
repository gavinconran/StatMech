### A1: Modifivation of "direct_pi_multirun.py" so that it computes the root mean square (rms) deviation:
...
pylab.title('Direct sampling of pi: root mean square deviation vs. n_trials 1')
