# C2_2.py
# extension of C2.py
# prints both parallel configurations at different time intervals
# program ends when coupling is reached
...
while True:
    ...
    if step % N == 0:
        ...
        if n_diff == 0:
            t_coup = step / N
            print 'coupling time:', t_coup, ' step:', step
            break 
    # plot after every 10 sweeps
    if (step % 10 == 0):
